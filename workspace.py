...
device = 'cuda';
data, labels = load_data('Hydrogen', device,ind_list=[i for i in range(250)]);
...
train1.optim = torch.optim.Adam(train1.model.parameters(), lr=1E-3);
for i in range(50):    
    loss = train1.pretrain(data, labels, kE=1,steps=10);
    print(loss);
...
# 
# for i in range(100):
#     loss = train1.pretrain_subspace(data, labels,norbs = 10, kE=1,steps=10);
#     print(loss);
# 
